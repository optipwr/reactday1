...
var Counter = React.createClass({
	// We also need to add getInitalState property that is part of React
	getInitialState: function() {
		// this function sets the initial state of a variable. It usually returns a single Object
		return {
			time: "60:00",
			score: 0
		}
